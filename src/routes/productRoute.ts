...
router.route("/")
  .post(userMiddleware.isUserLoggedIn, userMiddleware.accessTo(Roles.Admin), upload.single("productImage"), errorHandler(productController.createProduct))
...
router.route("/:id")
  ...
  .delete(userMiddleware.isUserLoggedIn, userMiddleware.accessTo(Roles.Admin), errorHandler(productController.deleteProduct))
